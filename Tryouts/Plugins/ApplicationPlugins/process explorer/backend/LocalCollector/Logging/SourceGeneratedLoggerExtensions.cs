...
internal static partial class SourceGeneratedLoggerExtensions
{
    ...
    private static partial void ConnectionStatusSendError(this ILogger logger, Exception ex, Exception exception);

    public static void ConnectionStatusChangedError(this ILogger logger, Exception exception)
    {
        if (logger.IsEnabled(LogLevel.Error))
        {
            ConnectionStatusSendError(logger, exception, exception);
        }
    }
