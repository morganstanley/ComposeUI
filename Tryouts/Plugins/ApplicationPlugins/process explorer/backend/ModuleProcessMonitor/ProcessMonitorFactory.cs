...
public static class ProcessMonitorFactory
{
    ...
    {
        return new ProcessInfoGeneratorWindows(logger);
    }

    public static ProcessInfoManager CreateProcessInfoGeneratorWindows(
        EventHandler<int> sendNewProcess,
        EventHandler<int> sendTerminatedProcess,
        EventHandler<int> sendModifiedProcess,
        ILogger<ProcessInfoManager>? logger = null)
    {
        return new ProcessInfoGeneratorWindows(sendNewProcess, sendTerminatedProcess, sendModifiedProcess, logger);
    }
}
