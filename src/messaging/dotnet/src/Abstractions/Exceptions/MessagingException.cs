...
/// <summary>
/// Represents an exception thrown by the messaging layer.
/// Errors thrown by other modules as well as the server can also manifest in this exception type on the client side.
/// </summary>
public class MessagingException : Exception
{
    ...
    public MessagingException(string name, string message) : base(message)
    {
        Name = name;        
    }
    ...
    public MessagingException(string name, string message, Exception innerException) : base(message, innerException)
    {
        Name = name;
    }
    ...
    public record Error
    {
        ...
        public Error(Exception exception) : this(exception is MessagingException mre ? mre.Name : exception.GetType().FullName!, exception.Message) { }
    ...
    /// <summary>
    /// Creates a new instance of <see cref="MessagingException"/> from the provided <see cref="Error"/> object.
    /// </summary>
    /// <param name="error"></param>
    public MessagingException(Error error) : this(error.Name, error.Message ?? error.Name) { }
