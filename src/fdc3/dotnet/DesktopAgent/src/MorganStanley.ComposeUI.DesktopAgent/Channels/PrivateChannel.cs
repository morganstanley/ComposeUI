...
{
    public PrivateChannel(string id, IMessageRouter messageRouter, ILogger<PrivateChannel>? logger)
        : base(id, messageRouter, (ILogger?) logger ?? NullLogger.Instance, Fdc3Topic.PrivateChannel(id)) { }
