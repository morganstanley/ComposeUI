...
{
    public TestChannel(string id, IMessaging messagingService, JsonSerializerOptions jsonSerializerOptions, ILogger logger, ChannelTopics topics)
        : base(id, messagingService, jsonSerializerOptions, logger, topics) { }

    protected override string ChannelTypeName => "user";
