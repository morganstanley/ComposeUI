...
public class EndToEndTests : IAsyncLifetime
{
    ...
    public async Task AddAppChannelReturnsNullWithNullChannelId()
    {
        ...
        var originFdc3InstanceId = Fdc3InstanceIdRetriever.GetFdc3InstanceId(instance);
    ...
    public async Task FindIntentsByContextReturnsAppIntent()
    {
        ...
        var fdc3InstanceId = Fdc3InstanceIdRetriever.GetFdc3InstanceId(moduleInstance);
    ...
    public async Task StoreIntentResultReturnsSuccessfully()
    {
        ...
        var targetFdc3InstanceId = Fdc3InstanceIdRetriever.GetFdc3InstanceId(targetInstance);
        ...
        var app2Fdc3InstanceId = Fdc3InstanceIdRetriever.GetFdc3InstanceId(app2);
    ...
    public async Task AddIntentListenerSubscribesWithExistingAppPerRaisedIntent()
    {
        ...
        var app4Fdc3InstanceId = Fdc3InstanceIdRetriever.GetFdc3InstanceId(app4);
    ...
    public async Task AddAppChannelReturnsSuccessfully()
    {
        ...
        try
        {
            var instanceId = Fdc3InstanceIdRetriever.GetFdc3InstanceId(origin);
