...
public interface IDesktopAgentClientFactory
{
    ...
    /// <summary>
    /// Registers the Fdc3Properties for in-process apps, which can be used to provide necessary information about the app to the DesktopAgentClient for proper Fdc3 integration. 
    ...
    /// The implementation of this method should handle the storage and management of the Fdc3Properties for in-process apps, ensuring that the DesktopAgentClient can access this information when needed for Fdc3 operations. 
    ...
    public Task RegisterInProcessAppPropertiesAsync(Fdc3Properties fdc3Properties);
}
