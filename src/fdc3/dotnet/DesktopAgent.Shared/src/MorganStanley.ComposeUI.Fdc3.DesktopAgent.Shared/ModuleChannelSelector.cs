...
/// <summary>
/// Implementation of <see cref="IModuleChannelSelector"/> that uses messaging to communicate channel selection.
/// This class can be used by both server-side (Desktop Agent) and client-side (native containers) to:
/// - Register handlers to receive channel join notifications from API calls
/// - Invoke channel joins from UI components
/// </summary>
public class ModuleChannelSelector : IModuleChannelSelector
{
