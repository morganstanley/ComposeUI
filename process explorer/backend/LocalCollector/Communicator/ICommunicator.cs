...
namespace ProcessExplorer.LocalCollector.Communicator
{
    public interface ICommunicator
    {
        ...
        /// <returns></returns>
        Task AddConnectionCollection(AssemblyInformation assemblyId, IEnumerable<ConnectionInfo> connections);
        ...
        /// <returns></returns>
        Task UpdateEnvironmentVariableInformation(AssemblyInformation assemblyId, IEnumerable<KeyValuePair<string, string>> environmentVariables);
        ...
        /// <returns></returns>
        Task UpdateRegistrationInformation(AssemblyInformation assemblyId, IEnumerable<RegistrationInfo> registrations);
        ...
        /// <returns></returns>
        Task UpdateModuleInformation(AssemblyInformation assemblyId, IEnumerable<ModuleInfo> modules);
    }
}
