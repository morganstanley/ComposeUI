...
This is a small server built with typescript and express that provides adaptive card templates in the form of json to be retrieved by the composui notification library. It is necessary to run the server in the terminal for the notification library to function as expected.
