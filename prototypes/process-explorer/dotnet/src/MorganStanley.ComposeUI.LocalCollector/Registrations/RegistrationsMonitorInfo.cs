...
namespace MorganStanley.ComposeUI.ProcessExplorer.LocalCollector.Registrations;

public class RegistrationMonitorInfo
{
    public SynchronizedCollection<RegistrationInfo> Services { get; internal set; } = new();
